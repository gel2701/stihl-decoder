...
import {
  ...
  PHASE_SOURCE_COMMIT,
  PHASE_RESULT_COMMIT,
  HISTORICAL_PUBLIC_STORE_CANONICAL_SHA256,
...
assert.strictEqual(report.SOURCE_PUBLIC_STORE_CANONICAL_SHA256, HISTORICAL_PUBLIC_STORE_CANONICAL_SHA256);
assert.strictEqual(report.RESULT_PUBLIC_STORE_CANONICAL_SHA256, HISTORICAL_PUBLIC_STORE_CANONICAL_SHA256);
assert.strictEqual(report.CURRENT_PUBLIC_STORE_CANONICAL_SHA256, EXPECTED_PUBLIC_STORE_CANONICAL_SHA256);
assert.strictEqual(report.PUBLIC_FACT_COUNT, 124);
