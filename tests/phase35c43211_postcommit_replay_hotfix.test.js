...
assert.strictEqual(report.REPLAY_SOURCE_COMMIT_FOUND, 'PASS');
assert.strictEqual(report.REPLAY_RESULT_COMMIT_FOUND, 'PASS');
assert.strictEqual(report.REPLAY_COMMIT_RELATION_VALID, 'PASS');
