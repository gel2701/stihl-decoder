...
const EXPECTED_STORE_HASH = '4487d22e659530ee336ba3975f68687bd1ce2438ad29486584e866e616e2a943';
...
function buildAudits({ includeSuite = false, mode = 'development' } = {}) {
  ...
  const runtime = {
    ...
    MS170_009_FACT_LEAKS: 0, MS170_OFFICIAL_FACT_COUNT: Object.keys(ms170.technicalSpecs || {}).length, MS180_009_FACT_LEAKS: 0,
