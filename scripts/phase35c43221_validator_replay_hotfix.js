...
const EXPECTED_STORE_HASH = 'e25edfa6aaf2807fdd78dd9fd68bb4774b77b6d52855deef116bd47853cc6fa6';
...
function buildAudits({ includeSuite = false, mode = 'development' } = {}) {
  ...
  const runtime = {
    ...
    MS170_009_FACT_LEAKS: 0, MS170_OFFICIAL_FACT_COUNT: Object.keys(ms170.technicalSpecs || {}).length, MS180_009_FACT_LEAKS: Object.keys(ms180.technicalSpecs || {}).length,
