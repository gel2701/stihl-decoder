...
const plantsData = [
  { plant_code: '1', country_code: 'DE', country_name: 'Duitsland', plant_location: 'Waiblingen / Prüm', notes: 'Hoofdfabriek & Kenniscentrum van STIHL. Onderzoeks- en ontwikkelingscentrum, productie van motorblokken en gepatenteerde zaagkettingen.' },
  { plant_code: '2', country_code: 'US', country_name: 'Verenigde Staten', plant_location: 'Virginia Beach, Virginia', notes: 'Grootste STIHL fabriek in de VS. Productie van benzine- en accumaaiers, trimmers, bladblazers en zaagkettingen.' },
  { plant_code: '3', country_code: 'BR', country_name: 'Brazilië', plant_location: 'São Leopoldo, Rio Grande do Sul', notes: 'Belangrijke fabriek voor de productie van cilinders, krukassen en complete motoren.' },
  { plant_code: '4', country_code: 'AT', country_name: 'Oostenrijk', plant_location: 'Langkampfen, Tirol', notes: 'Gespecialiseerd in accu-producten, grasmaaiers en tuinmachines.' },
  { plant_code: '5', country_code: 'US', country_name: 'VS / Duitsland', plant_location: 'Specifieke internationale productielijnen', notes: 'Wisselende assemblage- en componentenlijnen in de VS en Duitsland.' },
  { plant_code: '8', country_code: 'CN', country_name: 'China', plant_location: 'Qingdao', notes: 'STIHL Power Tools Qingdao voor consumenten- en semi-professionele gereedschappen.' },
  { plant_code: '9', country_code: 'BR', country_name: 'Brazilië / Overige', plant_location: 'Internationale assemblage', notes: 'Assemblagefabrieken voor specifieke regionale markten.' }
];
...
const modelsData = [
  ...
  },
  {
    ...
    spark_plug: 'NGK CMR6H / Bosch USR7AC',
    electrode_gap_mm: 0.50,
    carb_h_setting: 'M-Tronic (Elektronisch afgesteld)',
    carb_l_setting: 'M-Tronic (Elektronisch afgesteld)',
    carb_la_setting: 'M-Tronic (Elektronisch afgesteld)',
    chain_pitch: '.325"',
    chain_gauge_mm: 1.3,
    oil_mix_ratio: '1:50',
    is_discontinued: 0
  ...
  },
  {
    ...
    spark_plug: 'NGK CMR6H',
    electrode_gap_mm: 0.50,
    carb_h_setting: 'Injection (Elektronische Brandstofinjectie)',
    carb_l_setting: 'Injection (Elektronische Brandstofinjectie)',
    carb_la_setting: 'Injection (Elektronische Brandstofinjectie)',
    chain_pitch: '3/8"',
    chain_gauge_mm: 1.6,
    oil_mix_ratio: '1:50',
    is_discontinued: 0
  ...
  },
  {
    id: 'stihl_br_600',
    series_code: '4282',
    model_name: 'BR 500 / BR 550 / BR 600 / BR 700',
    category: 'Blower',
    ...
    spark_plug: 'NGK CMR6H',
    electrode_gap_mm: 0.50,
    carb_h_setting: '1 1/2 slag open',
    carb_l_setting: '1 slag open',
    carb_la_setting: '3100 RPM stationair',
    chain_pitch: 'N/A',
    chain_gauge_mm: 0.0,
    oil_mix_ratio: '1:50 (4-Mix Engine)',
    is_discontinued: 0
  },
  {
    id: 'stihl_fs_130',
...
const counterfeitRulesData = [
  ...
  },
  {
    ...
    risk_level: 'DEFINITIVE_FAKE',
    reason: 'Ongeldige fabriekscode. Het eerste cijfer van een echt STIHL serienummer moet 1 (DE), 2 (US), 3 (BR), 4 (AT), 5 (US/DE), 8 (CN) of 9 (BR) zijn.',
    affected_models: null
  },
  {
    pattern_regex: '^\\d{1,8}$',
    risk_level: 'HIGH',
    reason: 'Serienummer is korter dan 9 cijfers. Authentieke STIHL serienummers hebben altijd exact 9 cijfers.',
    affected_models: null
  },
  {
    pattern_regex: '^\\d{10}$',
    risk_level: 'HIGH',
    reason: 'Invoer bevat 10 cijfers. Mogelijk een typefout of een namaaklabel (STIHL gebruikt 9 cijfers voor serienummers en 11 cijfers voor onderdeelnummers).',
    affected_models: null
  },
  {
    pattern_regex: '^\\d{12,}$',
    risk_level: 'HIGH',
    reason: 'Langer dan 11 cijfers. Geen geldig STIHL serienummer of onderdeelnummer.',
    affected_models: null
  },
  {
    pattern_regex: '^999999999$|^123456789$|^888888888$',
    risk_level: 'DEFINITIVE_FAKE',
...
function seedDatabase() {
  ...
  // Also update stihl_database.json for fallback / client embedding
  const jsonDatabase = {
    plants: plantsData,
    models: modelsData,
    ...
    factories: {
      "1": {"country": "Duitsland", "location": "Waiblingen / Prüm", "details": "Hoofdfabriek & Kenniscentrum van STIHL. Onderzoeks- en ontwikkelingscentrum, productie van motorblokken en gepatenteerde zaagkettingen."},
      "2": {"country": "Verenigde Staten", "location": "Virginia Beach, Virginia", "details": "Grootste STIHL fabriek in de VS. Productie van benzine- en accumaaiers, trimmers, bladblazers en zaagkettingen."},
      "3": {"country": "Brazilië", "location": "São Leopoldo", "details": "Productie van cilinders, krukassen en complete motoren."},
      "4": {"country": "Oostenrijk", "location": "Langkampfen (Viking/Stihl)", "details": "Gespecialiseerd in accu-producten en grasmaaiers."},
      "8": {"country": "China", "location": "Qingdao", "details": "STIHL Power Tools Qingdao voor consumentengereedschappen."}
    },
    part_family_prefixes: {
      ...
      "1110": {"model": "041 AV / 041 Farm Boss", "type": "Kettingzaag (Klassieker)", "displacement": "61 cc", "power": "3.7 pk", "era": "1967 - 1986", "notes": "Legendarische zaag met AV (Anti-Vibratie) systeem."},
      "1121": {"model": "024 / 026 / MS 240 / MS 260", "type": "Kettingzaag (Professioneel)", "displacement": "44.3 cc - 50.2 cc", "power": "2.9 pk - 3.5 pk", "era": "1988 - 2011", "notes": "Eén van de meest verkochte professionele vellingszagen ter wereld."},
      "1127": {"model": "029 / 039 / MS 290 / MS 310 / MS 390", "type": "Kettingzaag (Landbouw / Semi-pro)", "displacement": "54.1 cc - 64.1 cc", "power": "3.8 pk - 4.6 pk", "era": "1993 - 2013", "notes": "Populair Farm & Ranch platform."},
      ...
      "1148": {"model": "MS 500i / MS 500i W", "type": "Kettingzaag (Elektronische Injectie)", "displacement": "79.2 cc", "power": "6.8 pk", "era": "2019 - heden", "notes": "'s Werelds eerste benzinezaag met elektronische brandstofinjectie Injection."},
      ...
      "1252": {"model": "MSA 300 C-O", "type": "Accu Kettingzaag (3.0 kW AP System)", "displacement": "36V Li-Ion", "power": "3.0 kW (4.1 pk)", "era": "2022 - heden", "notes": "De krachtigste professionele accukettingzaag met LED oliesensor."}
    }
  };
