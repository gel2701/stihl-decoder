  ...
  return (
    <form action="/" method="GET" class="space-y-4">
      <p class="text-xs text-gray-400">
        Vul hieronder het 9-cijferige serienummer in van uw {initialModelHint || 'STIHL machine'} om de fabriek, het exacte bouwjaar en het STIHL Paspoort op te vragen:
      </p>
